...
public class BeanRowMapper<T> implements RowMapper<T> {
    ...
    public BeanRowMapper(Class<T> clazz) {
        ...
        try {
            ...
            throw new DataAccessException(String.format(
                    "No public default constructor found for class %s when build BeanRowMapper.", clazz.getName()), e);
        }
    ...
    public T mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        try {
            ...
            throw new DataAccessException(String.format("Could not map result set to class %s", this.clazz.getName()),
                    e);
        }
        return bean;
    }
