...
public class MvcController {
    ...
    @ResponseBody
    String greeting(
            @RequestParam(value = "action", defaultValue = "Hello") String action,
    ...
    byte[] download(
            ...
            @RequestParam("time") Float downloadTime,
            @RequestParam("md5") String md5,
            @RequestParam("length") int length,
            @RequestParam("hasChecksum") boolean checksum) {
    ...
    ModelAndView product(
        ...
        return new ModelAndView("/product.html",
                Map.of("name", name, "product", Map.of("id", id, "name", "Winter Software")));
    }
