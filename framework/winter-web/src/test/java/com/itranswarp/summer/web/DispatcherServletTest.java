...
public class DispatcherServletTest {
    ...
    void getProduct() throws ServletException, IOException {
        ...
        assertTrue(resp.getContentAsString().contains("<a href=\"/product/123\">Winter Software</a>"));
    }
    ...
    void init() throws ServletException {
        ...
        var propertyResolver = creaPropertyResolver();
    ...
    PropertyResolver creaPropertyResolver() {
        var ps = new Properties();
        ps.put("app.title", "Scan App");
        ps.put("app.version", "v1.0");
        ps.put("winter.web.favicon-path", "/icon/favicon.ico");
        ps.put("winter.web.freemarker.template-path", "/WEB-INF/templates");
    ...
    MockHttpServletRequest createMockRequest(
            String method, String path, Object body, Map<String, String> params) {
